...
-- AddForeignKey
ALTER TABLE "teachersDisciplines" ADD CONSTRAINT "teachersDisciplines_discipleneId_fkey" FOREIGN KEY ("discipleneId") REFERENCES "disciplines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
